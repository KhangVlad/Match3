...
public class UIPopupManager : MonoBehaviour
{
    ...
    [SerializeField] private float moveUpDistance = 50f;  // How far the popup moves up
    ...
    [SerializeField] private int initialPoolSize = 3;  // Number of popups to pre-create
