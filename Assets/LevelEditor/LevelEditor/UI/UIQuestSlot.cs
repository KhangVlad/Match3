...
{
    public class UIQuestSlot : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        public static System.Action<UIQuestSlot> OnClicked;
        ...
        private void OnUITilSlotClicked(UIQuestSlot slot)
        {
            if (slot == this)
            {
                Select();
        ...
        public void SetData(QuestDataSO questData, int slotIndex)
        {
            this._questData = questData;
            this.SlotIndex = slotIndex;

            _iconImage.sprite = _questData.Icon;
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            Utilities.WaitAfter(0.25f, () =>
            {
                if (_isEnter)
                {
                    ...
                    UIPopupManager.Instance.SetNameInfoPopupContent(_questData.QuestID.ToString());
                }
            });
        }
