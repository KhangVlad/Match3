...
namespace Match3.LevelEditor
{
    public class LevelEditorManager : MonoBehaviour
    {
        ...
        public event System.Action<CharacterLevelDataV1> OnCharacterLevelDataLoaded;
        ...
        public CharacterLevelDataV1 CharacterLevelData;
        [SerializeField] private int _currentSelectLevel;


        #region Properties
        public int CurrentLevel => _currentSelectLevel;
        public LevelDataV1 SelectLevelData => CharacterLevelData.Levels[_currentSelectLevel];
        #endregion
        ...
        public CharacterLevelDataV1 InitializeNewChartacterLevelData()
        {
            CharacterLevelData = new();
            LevelDataV1 levelData = new LevelDataV1(0,0);
            CharacterLevelData.Levels.Add(levelData);
            OnCharacterLevelDataLoaded?.Invoke(CharacterLevelData);        
            return CharacterLevelData;
        }
        public void SetCharacterLevelData(CharacterLevelDataV1 characterLevelData)
        {
        ...
        public void SaveLevelData(int index, LevelDataV1 levelData)
        {
